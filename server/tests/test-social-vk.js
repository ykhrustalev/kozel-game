...
describe("vk", function () {
  describe("handler", function () {
    ...
    describe("#cantHandle()", function () {

      it("should identify request that can be handled", function (done) {
        should.exist(handler.canHandle(getMockRequest("http://vk.com")));
        done();
      });

      it("should identify request that can't be handled", function (done) {
    ...
    describe("#handle()", function () {
      ...
      it("should handle valid requests", function (done) {
        handler.handle(getMockRequest(assets.valid), function (error, profile) {
      ...
      it("should fail with incorrect apiId", function (done) {
        handler.handle(getMockRequest(assets.invalidApiId), function (error) {
          should.exist(error);
          done();
        });
      });

      it("should fail with incorrect authKey", function (done) {
        handler.handle(getMockRequest(assets.invalidAuthKey), function (error) {
          should.exist(error);
          done();
        });
      });

      it("should fail with missing viewerId", function (done) {
        handler.handle(getMockRequest(assets.invalidMissingViewerId), function (error) {
          should.exist(error);
          done();
        });
      });

      it("should fail with missing api_result", function (done) {
        handler.handle(getMockRequest(assets.missingApiResult), function (error) {
          should.exist(error);
          done();
        });
      });
